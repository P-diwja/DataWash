...
st.markdown("""
    ...
    <style>
        ...
        */
        ...
        /* ---------- FILE UPLOADER - explicit contrast-safe text everywhere ---------- */
        section[data-testid="stFileUploaderDropzone"] {
            background-color: #FFFFFF;
            border: 1.5px dashed #E9E7E0;
            border-radius: 10px;
        }
        ...
        /* Uploaded filename + size, after a file is selected */
        ...
        /* Filename specifically - truncate gracefully instead of overflowing */
